...
public class ConnectionLine : MonoBehaviour
{
    ...
    {
        int xDistance = Mathf.CeilToInt(Math.Abs(origin.x - end.position.x));
        int yDistance = Mathf.CeilToInt(Math.Abs(origin.y - end.position.y));
